...
docs/
  charters/   human-facing standards + rationale (backend, frontend, database,
              dependency-management, commit-writing, pr-writing, general,
              testing)
...
- `charters/general.md` and `charters/testing.md` are placeholders that point at
  where the rules actually live — do not treat them as authoritative.
