...
| `commit-writing.md`        | Commit message conventions                                          |
| `pr-writing.md`            | Pull request conventions                                            |
| `general.md`               | Placeholder — not yet written                                       |
| `testing.md`               | Placeholder — not yet written                                       |
