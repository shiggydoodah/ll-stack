...
phasing, whether a feature should exist), ask the user. The backend currently
ships the health module plus the platform infrastructure; the auth/users
modules land in the next phase and are used as the worked examples throughout
the docs.
