...
// Pinned to UTC for the reason SessionsPanel gives: this client component is
// server-rendered first, and `joinedAt` is a full UTC instant, so an unpinned
// formatter shifts the rendered day for any viewer whose zone offset spans the
// row's time of day — a hydration mismatch, not a cosmetic one.
