...
see `CONTEXT.md`. For the rules on consuming these in the app, see
...
| `Heading` (`.H1`–`.H6`)        | Semantic heading on the shared typography scale.   | `level: h1–h6` · `size: xs·small·medium·large·xl·2xl` · `weight` · `tracking` · `leading` · `tone`                                                                                    |
| `Display`                      | Large non-semantic display text (heading scale).   | `level: h1–h6` · `size: xs·small·medium·large·xl·2xl` · `weight` · `tracking` · `leading` · `tone`                                                                                    |
...
| `Checkbox`       | Controlled checkbox input.                                                         | `checked` · `onCheckedChange`                                                                                       |
...
| `Badge`           | Compact label for status / categorisation.                                                                                                                              | `tone(7)` · `variant: solid·surface·soft·outline`                                                                                                                    |
...
_Full API → `src/ui/integrations/form/index.ts` (+ `fields/`, `submit/`). Examples → real usage in `apps/frontend` (e.g. `app/(public)/login/LoginForm.tsx`)._
