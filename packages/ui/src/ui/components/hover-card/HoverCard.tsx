...
export const HoverCard = ({
  ...
  // On touch devices the preview is forced closed: hover/focus never opens it and the content
  // never mounts, leaving the trigger child to behave as a plain link/tap target.
  if (suppressed) {
    return <HoverCardPrimitive.Root open={false}>{children}</HoverCardPrimitive.Root>;
  }
