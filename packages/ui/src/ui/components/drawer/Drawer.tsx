 ...
 * so you rarely use this directly. Fades in/out with the drawer's open state.
 */
 ...
 * `left`/`right`). vaul animates the slide itself; we only style the surface and fade the
 * overlay.
 *
